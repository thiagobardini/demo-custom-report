...
test_1.test.describe("GlobalLink Go @smoke", () => {
    // Heavy tests - only run on Chromium
    test_1.test.setTimeout(130000);
    test_1.test.skip(({ browserName }) => browserName !== "chromium", "Test only runs on Chromium.");
    ...
    const globalLinkGoPort = configConstants_json_1.default.glgoMarketing;
    // Setup the test environment
    (0, generalTestUtils_1.goToPort)(globalLinkGoPort);
    websites.forEach((data) => {
        const { id, url, email } = data;
        (0, test_1.test)(`${url}`, async ({ page }, testInfo) => {
            testInfo.duration;
            ...
            const isUrlFilled = await page
                ...
                .evaluate((node) => node.value.length > 0);
            ...
            await Promise.race([
                ...
                page
                    ...
                    await (0, customReport_1.customReportTestInfoCondition)(params);
                }),
            ]);
            ...
            const analyzedWords = analyzedWordsText
            ...
            if (crmAPIResponse.status() !== 200) {
                ...
                await (0, test_1.expect)(async () => {
                    ...
                    await (0, customReport_1.customReportTestInfoConditionPass)(params);
                }).toPass();
            }
        });
    });
