...
const websites = [
  { id: "001", url: "www.tbardini.com", email: "contact@bookshop.org", reporter: "Thiago" },
  { id: "002", url: "mantine.dev", email: "contact@mantine.com", reporter: "Thiago" },
  { id: "003", url: "forbes.com", email: "contact@forbes.com", reporter: "Thiago" },
  { id: "004", url: "techcrunch.com", email: "contact@techcrunch.com", reporter: "Thiago" },
  { id: "005", url: "theguardian.com", email: "contact@theguardian.com", reporter: "Thiago" },
  { id: "006", url: "wired.com", email: "contact@wired.com", reporter: "Thiago" },
  { id: "007", url: "foodnetwork.com", email: "contact@foodnetwork.com", reporter: "Thiago" },
  { id: "008", url: "smittenkitchen.com", email: "contact@smittenkitchen.com", reporter: "Thiago" },
  { id: "009", url: "thepioneerwoman.com", email: "contact@thepioneerwoman.com", reporter: "Thiago" },
  { id: "010", url: "food52.com", email: "contact@food52.com", reporter: "Thiago" },
  { id: "011", url: "thekitchn.com", email: "contact@thekitchn.com", reporter: "Thiago" },
  { id: "012", url: "cooksillustrated.com", email: "contact@cooksillustrated.com", reporter: "Thiago" },
  { id: "013", url: "delish.com", email: "contact@delish.com", reporter: "Thiago" },
  { id: "014", url: "cookstr.com", email: "contact@cookstr.com", reporter: "Thiago" },
  { id: "015", url: "simplyrecipes.com", email: "contact@simplyrecipes.com", reporter: "Thiago" },
  { id: "016", url: "www.kfc.com", email: "contact@test.com", reporter: "Thiago" },
  { id: "017", url: "www.lowes.com", email: "contact@test.com", reporter: "Thiago" },
  { id: "018", url: "www.pizzahut.com", email: "contact@test.com", reporter: "Thiago" },
  { id: "019", url: "www.homedepot.com", email: "contact@test.com", reporter: "Thiago" },
  { id: "020", url: "openai.com", email: "contact@test.com", reporter: "Thiago" },
];
...
test.describe("GlobalLink Go @smoke", () => {
  ...
  websites.forEach((data) => {
    ...
    test(`${url}`, async ({ page }, testInfo) => {
      ...
      const isUrlFilled = await page.getByLabel("Your Website *").evaluate((node: HTMLInputElement) => node.value.length > 0);
      const isEmailFilled = await page.getByLabel("Your Email *").evaluate((node: HTMLInputElement) => node.value.length > 0);
      ...
      const quickQuoteResponsePromise = page.waitForResponse((response) => response.url().includes(`QuickQuote?domain=${encodedWebsiteUrl}`), { timeout: 130000 });

      // Listen for the CRM API response
      const crmAPIResponsePromise = page.waitForResponse((response) => response.url().includes(`CRM/objects/contacts`), { timeout: 130000 });
      ...
      await page.waitForRequest((request) => request.url().includes("QuickQuote?domain="), { timeout: 130000 });

      // Go to the Words Served Estimate page
      await Promise.race([
        page.goto(`${globalLinkGoPort}/estimate?domain=${url}&email=${email}`, { waitUntil: "load", timeout: 130000 }),
      ...
      const analyzedWordsText = await page.getByTestId("pw-analyzed-words").textContent({ timeout: 130000 });
      const analyzedWords: number | null = analyzedWordsText ? parseInt(analyzedWordsText, 10) : null;
      ...
      if ((analyzedWords === null || analyzedWords === 0 || isNaN(analyzedWords)) && quickQuoteResponse.ok()) {
